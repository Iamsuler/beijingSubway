(function ($) {
    ...
    var plugin = {
        ...
        _drawLineName: function (name, rc, lc, ismask) {
            ...
            text.move(this._offsetNumber(this._parseNumber(rs[0])) + this._parseNumber(rs[2])/2, this._offsetNumber(this._parseNumber(rs[1]))).font({ fill: 'white', family: '微软雅黑', size:  12});
        ...
        _drawErrorIcon: function(){
          ...
          img.attr({"sdata": "天安门西","acc": "150995216"});
        ...
        _drawStation: function (linexml, dn, ismask) {
            ...
            if (cp.attr("st") == "true") {
                if (!(this._parseNumber(cp.attr("rx")) == 0 && this._parseNumber(cp.attr("ry")) == 0)) {
                    ...
                    text.move(this._offsetNumber(this._parseNumber(cp.attr("x")))+this._parseNumber(cp.attr("rx")), this._offsetNumber(this._parseNumber(cp.attr("y")))+this._parseNumber(cp.attr("ry")) + 5).font({ fill: lc, family: '微软雅黑', size:  12});
                    if (ismask)
                        text.addClass('mask');
                    ...
                    if (cp.attr("iu") == "false") {
                        ...
                        text.move(this._offsetNumber(this._parseNumber(cp.attr("x")))+this._parseNumber(cp.attr("rx")), this._offsetNumber(this._parseNumber(cp.attr("y")))+this._parseNumber(cp.attr("ry"))+this._parseNumber(18)).font({ fill: lc, family: '微软雅黑', size:  12});
                        if (ismask)
                            text.addClass('mask');
